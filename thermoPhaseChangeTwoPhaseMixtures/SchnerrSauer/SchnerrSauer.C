...
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::SchnerrSauer
(
...
:
    ...
    n_("n", dimless/dimVolume, thermoPhaseChangeTwoPhaseMixtureCoeffs_),
    dNuc_("dNuc", dimLength, thermoPhaseChangeTwoPhaseMixtureCoeffs_),
...
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::rRb
(
...
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::alphaNuc() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::pCoeff
(
...
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::mDotP() const
{
    const volScalarField& p = alpha1().db().lookupObject<volScalarField>("p");
    volScalarField pCoeff(this->pCoeff(p));
...
void Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::correct()
{
    thermoPhaseChangeTwoPhaseMixture::correct();
}


bool Foam::thermoPhaseChangeTwoPhaseMixtures::SchnerrSauer::read()
{
    if (thermoPhaseChangeTwoPhaseMixture::read())
    {
        thermoPhaseChangeTwoPhaseMixtureCoeffs_ = optionalSubDict(type() + "Coeffs");

        thermoPhaseChangeTwoPhaseMixtureCoeffs_.lookup("n") >> n_;
        thermoPhaseChangeTwoPhaseMixtureCoeffs_.lookup("dNuc") >> dNuc_;
