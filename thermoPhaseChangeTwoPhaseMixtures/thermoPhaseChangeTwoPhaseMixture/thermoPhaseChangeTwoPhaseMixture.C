...
namespace Foam
{
    defineTypeNameAndDebug(thermoPhaseChangeTwoPhaseMixture, 0);
    defineRunTimeSelectionTable(thermoPhaseChangeTwoPhaseMixture, components);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::thermoPhaseChangeTwoPhaseMixture::thermoPhaseChangeTwoPhaseMixture
(
    const word& type,
...
Foam::thermoPhaseChangeTwoPhaseMixture::vDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::thermoPhaseChangeTwoPhaseMixture::vDotP() const
{
...
void Foam::thermoPhaseChangeTwoPhaseMixture::correct()
{
    thermoImmiscibleIncompressibleTwoPhaseMixture::correct();
}


bool Foam::thermoPhaseChangeTwoPhaseMixture::read()
{
